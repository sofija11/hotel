...
<!-- Mirrored from cyclonethemes.com/demo/html/hotux/room-select.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 26 Jan 2020 22:21:31 GMT -->
<head>

    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1">

    <title>Room Select | Hotux</title>
    <!-- Favicon -->
    <link rel="shortcut icon" type="image/x-icon" href="images/favicon.png">
    <!-- Bootstrap core CSS -->
    <link href="app/assets/css/bootstrap.min.css" rel="stylesheet" type="text/css">
    <!--Default CSS-->
    <link href="app/assets/css/default.css" rel="stylesheet" type="text/css">
    <!--Custom CSS-->
    <link href="app/assets/css/style.css" rel="stylesheet" type="text/css">
    <!--Plugin CSS-->
    <link href="app/assets/css/plugin.css" rel="stylesheet" type="text/css">
    <!--Font Awesome-->
                ...
                <div class="container">
                    ...
                    <div class="navbar-header">
                        <a class="navbar-brand" href="index.html">
                            ...
                            <img alt="Image" src="images/logo-black.png" class="logo-black">
                        </a>
                    </div>
                    ...
                    <div class="col-md-9 pull-right">
                        ...
                        <div class="list-content">
                            <div class="list-grid">
                                <div class="room-grid">
                                    ...
                                    <div class="grid-content">
                                        ...
                                        <div class="grid-btn mar-top-20">
                                            <a href="detail-full.html" class="btn btn-black mar-right-10">VIEW DETAILS</a>
                                            <a href="booking.html" class="btn btn-orange">BOOK NOW</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="room-grid">
                                    <div class="grid-image">
                                        <img src="images/room-list/grid2.jpg" alt="image">
                                    </div>
                                    <div class="grid-content">
                                        <div class="room-title">
                                            <h4>Deluxe Suite</h4>
                                ...
                                <div class="room-grid">
                                    <div class="grid-image">
                                        <img src="images/room-list/grid3.jpg" alt="image">
                                    </div>
                                    <div class="grid-content">
                                        <div class="room-title">
                                ...
                                <div class="room-grid">
                                    <div class="grid-image">
                                        <img src="images/room-list/grid4.jpg" alt="image">
                                    </div>
                                    <div class="grid-content">
                                        <div class="room-title">
                                            <h4>Normal Suite</h4>
                                ...
                                <div class="room-grid">
                                    <div class="grid-image">
                                        <img src="images/room-list/grid5.jpg" alt="image">
                                    </div>
                                    <div class="grid-content">
                                        <div class="room-title">
                                            <h4>Royal Suite</h4>
